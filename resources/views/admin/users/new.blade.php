...
@section('content-header')
    <h1>Создать пользователя<small>Добавьте нового пользователя в систему.</small></h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <div>
                            ...
                            <p class="text-muted"><small>Язык, используемый по умолчанию при отображении панели для этого пользователя.</small></p>
                        </div>
                    </div>
                </div>
                ...
                <div class="box-body">
                    <div class="form-group col-md-12">
                        ...
                        <div>
                            ...
                            <p class="text-muted"><small>Если выбрано «Да», пользователь будет иметь полный административный доступ.</small></p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="box">
                ...
                <div class="box-body">
                    <div class="alert alert-info">
                        <p>Указание пароля пользователя является необязательным. В электронных письмах нового пользователя будет предложено создать пароль при первом входе. Если здесь указан пароль, вам потребуется найти другой способ предоставления его пользователю.</p>
                    </div>
