...
<div class="row">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group no-margin-bottom">
                        ...
                        <div>
                            ...
                            <p class="text-muted small">Оставьте пустым, чтобы оставить пароль этого пользователя неизменным. Пользователь не получит никакого уведомления, если пароль будет изменен.</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="col-xs-12">
        <div class="box box-danger">
            ...
            <div class="box-body">
                <p class="no-margin">Для удаления учетной записи не должно быть серверов, связанных с ней..</p>
            </div>
            <div class="box-footer">
                <form action="{{ route('admin.users.view', $user->id) }}" method="POST">
                    {!! csrf_field() !!}
