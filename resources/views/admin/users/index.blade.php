                ...
                <table class="table table-hover">
                    <thead>
                        <tr>
                            ...
                            <th class="text-center"><span data-toggle="tooltip" data-placement="top" title="Серверы, которыми владеет данный пользователь.">Владеет серверами</span></th>
                            <th class="text-center"><span data-toggle="tooltip" data-placement="top" title="Серверы, к которым данный пользователь имеет доступ как подпользователь.">Имеет доступ</span></th>
                            <th></th>
                        </tr>
                    </thead>
                    <tbody>
