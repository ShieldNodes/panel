                                ...
                                <div>
                                    <div class="btn-group" data-toggle="buttons">
                                        ...
                                        <label class="btn btn-primary @if ($level == 1) active @endif">
                                            <input type="radio" name="pterodactyl:auth:2fa_required" autocomplete="off" value="1" @if ($level == 1) checked @endif> Только администраторы
                                        </label>
                                    ...
                                    <p class="text-muted"><small>При включении любая учетная запись, попадающая в выбранную группу, должна будет включить двухфакторную аутентификацию для использования панели.</small></p>
                                </div>
                            </div>
                            <div class="form-group col-md-4">
                                ...
                                <div>
                                    ...
                                    <p class="text-muted"><small>Язык по умолчанию, используемый при отображении компонентов пользовательского интерфейса.</small></p>
                                </div>
                            </div>
                        </div>
                    </div>
