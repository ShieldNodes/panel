    ...
    return (
        <Formik onSubmit={updateGSLToken} initialValues={{ gslToken: '' }}>
            ...
            >
                ...
                <Form>
                    <h2 css={tw`text-2xl mb-4 text-neutral-100`}>Недействительный токен GSL!</h2>
                    <p css={tw`mt-4`}>
                        Похоже, ваш токен для входа в Gameserver (токен GSL) недействителен или срок его действия истек.
                    </p>
                    <p css={tw`mt-4`}>
                        Вы можете создать новый и ввести его ниже или оставить поле пустым, чтобы удалить его.
                        полностью.
                    </p>
