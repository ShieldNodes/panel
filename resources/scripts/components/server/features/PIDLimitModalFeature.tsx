        ...
        >
            ...
            {isAdmin ? (
                <>
                    ...
                    <p css={tw`mt-4`}>Этот сервер достиг максимального предела процесса или памяти.</p>
                    <p css={tw`mt-4`}>
                    Увеличение <code css={tw`font-mono bg-neutral-900`}>container_pid_limit</code>
                    в конфигурации Wings, <code css={tw`font-mono bg-neutral-900`}>config.yml </code>,
                ...
                <>
                    ...
                    <p css={tw`mt-4`}>
                        ...
                        и дайте им ошибку ниже.
                    </p>
                    <p css={tw`mt-4`}>
                        <code css={tw`font-mono bg-neutral-900`}>
                            pthread_create не удалось, возможно, недостаточно памяти или достигнуты ограничения процесса/ресурса
                        </code>
                    </p>
                    <div css={tw`mt-8 sm:flex items-center justify-end`}>
                        <Button onClick={() => setVisible(false)} css={tw`w-full sm:w-auto border-transparent`}>
