        ...
        <Formik
            ...
            validationSchema={object().shape({
                email: string()
                    ...
                    .required('Необходимо указать действующий адрес электронной почты.'),
            ...
            <Form>
                <div css={tw`flex justify-between`}>
                    <h2 css={tw`text-2xl`} ref={ref}>
                        {subuser
                            ...
                            : 'Создать нового субпользователя'}
                    </h2>
                    <div>
                ...
                {!isRootAdmin && loggedInPermissions[0] !== '*' && (
                    <div css={tw`mt-4 pl-4 py-2 border-l-4 border-cyan-400`}>
                        ...
                        При создании или изменении других пользователей можно выбрать только те разрешения, которые в
                        настоящее время назначены вашей учетной записи.
                        </p>
                    </div>
                )}
                {!subuser && (
                    <div css={tw`mt-6`}>
                        <Field
                            ...
                            description={
                                'Введите адрес электронной почты пользователя, которого вы хотите пригласить в качестве субпользователя на этот сервер.'
                            }
                        />
                    </div>
                )}
