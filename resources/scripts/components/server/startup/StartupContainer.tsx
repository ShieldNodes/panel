                    ...
                    {Object.keys(data.dockerImages).length > 1 && !isCustomImage ? (
                        <>
                            ...
                            <p css={tw`text-xs text-neutral-300 mt-2`}>
                                Это расширенная функция, позволяющая выбрать образ Docker для использования при запуске
                                данного экземпляра сервера.
                            </p>
                        </>
                    ) : (
                        <>
                            ...
                            {isCustomImage && (
                                <p css={tw`text-xs text-neutral-300 mt-2`}>
                                    Этот {"server's"} образ Docker был установлен администратором вручную и не может быть
                                    не может быть изменен через этот пользовательский интерфейс.
                                </p>
                            )}
                        </>
                    )}
