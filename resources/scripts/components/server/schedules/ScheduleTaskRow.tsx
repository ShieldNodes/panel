...
export default ({ schedule, task }: Props) => {
    ...
    return (
        <div css={tw`sm:flex items-center p-3 sm:p-6 border-b border-neutral-800`}>
            ...
            >
                Вы уверены, что хотите удалить эту задачу? Это действие не может быть отменено.
            </ConfirmationModal>
            ...
            <div css={tw`mt-3 sm:mt-0 flex items-center w-full sm:w-auto`}>
                ...
                <Can action={'schedule.update'}>
                    <button
                        type={'button'}
                        aria-label={'Изменить запланированное задание'}
                ...
                <Can action={'schedule.update'}>
                    <button
                        type={'button'}
                        aria-label={'Удалить запланированное задание'}
