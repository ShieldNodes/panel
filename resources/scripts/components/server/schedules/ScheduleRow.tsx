    ...
    <>
        ...
        <div css={tw`flex-1 md:ml-4`}>
            ...
            <p css={tw`text-xs text-neutral-400`}>
                Последний запуск: {schedule.lastRunAt ? format(schedule.lastRunAt, "MMM do 'at' h:mma") : 'never'}
            </p>
        </div>
        <div>
            <p
            ...
            >
                {schedule.isActive ? 'Активный' : 'Неактивный'}
            </p>
        </div>
        ...
        <div>
            ...
            >
                {schedule.isProcessing ? 'Обработка' : schedule.isActive ? 'Активный' : 'Неактивный'}
            </p>
        </div>
    </>
);
