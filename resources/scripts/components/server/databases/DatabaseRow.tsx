    ...
    return (
        <>
            <Formik onSubmit={submit} initialValues={{ confirm: '' }} validationSchema={schema} isInitialValid={false}>
                {({ isSubmitting, isValid, resetForm }) => (
                    ...
                    >
                        ...
                        <p css={tw`text-sm`}>
                            Удаление базы данных — это постоянное действие, его нельзя отменить. Это навсегда удалит
                            базу данных <strong>{database.name}</strong> и удалит все связанные данные.
                        </p>
                        <Form css={tw`m-0 mt-6`}>
                            <Field
                                ...
                                description={'Введите имя базы данных, чтобы подтвердить удаление.'}
                            />
            ...
            <Modal visible={connectionVisible} onDismissed={() => setConnectionVisible(false)}>
                ...
                <h3 css={tw`mb-6 text-2xl`}>Сведения о подключении к базе данных</h3>
                <div>
                ...
                <div css={tw`mt-6`}>
                    <Label>Строка соединения JDBC</Label>
