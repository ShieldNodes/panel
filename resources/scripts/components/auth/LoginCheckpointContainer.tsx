        ...
        <LoginFormContainer title={'Контрольная точка устройства'} css={tw`w-full flex`}>
            <div css={tw`mt-6`}>
                <Field
                    ...
                    description={
                        isMissingDevice
                            ? 'Введите один из кодов восстановления, сгенерированных при настройке двухфакторной аутентификации для этой учетной записи, чтобы продолжить.'
            ...
            <div css={tw`mt-6 text-center`}>
                ...
                >
                    {!isMissingDevice ? "Устройство потеряно" : 'У меня есть устройство'}
                </span>
            </div>
            <div css={tw`mt-6 text-center`}>
                <Link
